...
Based off my observation when you knit it it gives a different number every time that only slightly differs from the one before. It also gives us the value of the standard deviation. It was approximately 41.73 the first time. Then we ran it again as k9 and got approximately 14.00 . I expect the number of k16 to be half of k9 and it was close this number was approximately 10.50.
